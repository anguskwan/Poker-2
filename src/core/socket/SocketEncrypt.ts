class SocketEncrypt {
	...
	public static InitEncrypt(m_SendByteMap: egret.ByteArray, m_RecvByteMap: egret.ByteArray): void {
	...
	public static encode(sourceBuffer: egret.ByteArray, beginPosition: number, totalSize: number, sendByteMap: egret.ByteArray): number {
		var encryptCode: number = 0;
		for (var i: number = beginPosition; i < totalSize; i++) {
